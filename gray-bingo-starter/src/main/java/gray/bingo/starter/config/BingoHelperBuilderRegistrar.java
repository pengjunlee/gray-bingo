...
public class BingoHelperBuilderRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata annotationMetadata, BeanDefinitionRegistry beanDefinitionRegistry) {
        BingoHelperBuilderRegistrar.registryAllHelperBuilders(annotationMetadata,beanDefinitionRegistry);
    }

    public static void registryAllHelperBuilders(AnnotationMetadata annotationMetadata, BeanDefinitionRegistry beanDefinitionRegistry) {
