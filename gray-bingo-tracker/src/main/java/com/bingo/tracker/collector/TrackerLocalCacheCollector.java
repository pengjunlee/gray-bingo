package com.bingo.tracker.collector;
import com.bingo.common.concurrent.NamedThreadFactory;
import com.bingo.common.utils.SpringUtil;
import com.bingo.tracker.common.SpanNode;
import com.bingo.tracker.common.Tracker;
import com.bingo.tracker.common.TrackerConstants;
import com.bingo.tracker.config.TrackerProperties;
...
public class TrackerLocalCacheCollector implements TrackerCollector {
    ...
    private boolean ignore(SpanNode spanNode) {
        if (CollectionUtils.isEmpty(properties.getCollector().getIgnoreTrackers())) {
            return false;
        }
