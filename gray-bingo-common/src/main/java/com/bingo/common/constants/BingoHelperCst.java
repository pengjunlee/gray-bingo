...
public class BingoHelperCst {
    ...
    // Helper 名称常量
    public static final String BINGO_HELPER_CODE_CAFFEINE = "caffeine";
    public static final String BINGO_HELPER_CODE_DYNAMIC_DB = "dynamic_db";

    // Helper 完整配置常量，例如：bingo.helper.caffeine
    public static final String BINGO_HELPER_CONFIG_CAFFEINE = BINGO_HELPER_CONF_PREFIX + BINGO_HELPER_CODE_CAFFEINE;

    public static final String BINGO_HELPER_CONFIG_DYNAMIC_DB = BINGO_HELPER_CONF_PREFIX + BINGO_HELPER_CODE_DYNAMIC_DB;
