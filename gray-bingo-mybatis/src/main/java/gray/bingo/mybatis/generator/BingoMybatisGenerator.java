...
public class BingoMybatisGenerator {
     ...
     */
    public static void generate(String[] tablesNames, BingoMybatisGeneratorConfig generatorConfig) {
     ...
     * 获取路径信息map
     */
    private static Map<OutputFile, String> getPathInfo(BingoMybatisGeneratorConfig generatorConfig) {
