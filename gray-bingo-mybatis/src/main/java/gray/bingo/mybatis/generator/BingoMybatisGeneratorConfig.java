 ...
 * @日期 2024-01-21 16:15
 */
public class BingoMybatisGeneratorConfig {
    ...
    public static class SingleModuleBuilder {
        ...
        private final BingoMybatisGeneratorConfig generatorConfig;

        public SingleModuleBuilder() {
            super();
            this.generatorConfig = new BingoMybatisGeneratorConfig(false);
        }
         ...
         */
        public BingoMybatisGeneratorConfig build() {
            beforeBuild();
    ...
    public static class MultiModuleBuilder {
        ...
        public MultiModuleBuilder() {
            super();
            this.generatorConfig = new BingoMybatisGeneratorConfig(true);
        }
    ...
    private BingoMybatisGeneratorConfig(boolean multiModule) {
        super();
    }
