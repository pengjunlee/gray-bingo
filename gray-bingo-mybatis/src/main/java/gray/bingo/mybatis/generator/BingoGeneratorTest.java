...
public class BingoGeneratorTest {
    ...
    private static void mybatisGenerate() {
        ...
        BingoMybatisGenerator.generate(is);
    }
 ...
 */
        ...
        BingoPlusConfig generatorConfig = BingoPlusConfig.build4MultiModule()
                .author("二月菌")
                .enableSwagger(false)
...
//                .build();
        BingoMybatisGenerator.generate(builder, tableNames, generatorConfig);
    }
